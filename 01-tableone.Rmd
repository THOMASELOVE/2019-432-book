...
Consider the simulated data, available on the Data and Code page of [our course website](https://github.com/THOMASELOVE/2019-432) in the `fakestroke.csv` file, which I built to let us mirror the Table 1 for MR CLEAN [@Berkhemer2015]. The `fakestroke.csv` file contains the following 18 variables for 500 patients.
...
Consider the data, available on the Data and Code page of [our course website](https://github.com/THOMASELOVE/2019-432) in the `bloodbrain.csv` file, which includes the following variables:
